...
export const landing = {
  ...
  pricing: {
    ...
    s1: ["10 invoices (10 credits)", "10 invoice (10 kredit)"] as Pair, s2: ["PayPal payment", "Pembayaran PayPal"] as Pair, s3: ["Basic analytics", "Analitik dasar"] as Pair,
    ...
    note: [
      "Plans are billed in USD through PayPal; the rupiah figure is an estimate. Payments currently run in the PayPal sandbox, so no real money is charged.",
      "Paket ditagih dalam USD lewat PayPal; angka rupiah adalah perkiraan. Saat ini pembayaran berjalan di PayPal Sandbox, jadi tidak ada uang asli yang ditarik.",
    ] as Pair,
  },
  faq: {
