...
export default function Landing({ signedIn }: { signedIn: boolean }) {
  ...
  const startHref = signedIn ? "/dashboard/new-invoice" : "/signup";
  const startLabel = signedIn ? t("nav.createInvoice") : t("nav.getStarted");
    ...
    <main className="landing">
        ...
        {menuOpen && (
          <nav id="mobile-nav" className="mobile-nav" aria-label="Mobile navigation">
            <div className="site-shell">
              ...
              <Link href={signedIn ? "/dashboard" : "/login"} onClick={() => setMenuOpen(false)}>
                {signedIn ? t("nav.dashboard") : t("footer.login")}
              </Link>
            </div>
          </nav>
        )}
          ...
          <div className="agency-hero-copy">
            ...
            <div className="hero-actions hero-enter hero-enter-3">
              <Link href={startHref} className="btn btn-primary btn-lg">
                {signedIn ? t("hero.ctaSignedIn") : t("hero.cta1")}
              </Link>
      ...
      <section id="why" className="site-shell section-space split-section">
        ...
        <AnimatedContent delay={0.08}>
          ...
          <Link href={startHref} className="btn btn-primary">{t("why.cta")}</Link>
        </AnimatedContent>
      </section>
      ...
      <section id="features" className="section-space muted-band">
        <div className="site-shell">
          <AnimatedContent className="section-top">
            ...
            <Link href={startHref} className="btn btn-ghost">{startLabel}</Link>
          </AnimatedContent>
              ...
              return (
                <AnimatedContent className="reveal-item" key={num} delay={(index % 3) * 0.06}>
                  <SpotlightCard className="feature-card">
                    ...
                    <Link href={startHref}>{t("features.tryCta")}</Link>
                  </SpotlightCard>
                </AnimatedContent>
              );
            })}
      ...
      <section id="reward" className="reward-band section-space">
        <AnimatedContent className="site-shell reward-inner">
          ...
          <Link href={startHref} className="btn btn-primary btn-lg">{t("reward.cta")}</Link>
        </AnimatedContent>
      </section>
      ...
      <section id="pricing" className="site-shell section-space">
        ...
        <div className="pricing-grid">
          <AnimatedContent className="reveal-item plan">
            ...
            <Link href={startHref} className="btn btn-ghost" style={{ width: "100%" }}>{t("pricing.ctaStart")}</Link>
          </AnimatedContent>
      ...
      <AnimatedContent as="section" className="site-shell section-space final-cta">
        ...
        <Link href={startHref} className="btn btn-primary btn-lg">{signedIn ? t("hero.ctaSignedIn") : t("finalCta.cta")}</Link>
      </AnimatedContent>
      ...
      <footer className="site-footer">
        <div className="site-shell footer-inner">
          ...
          <nav>
            ...
            <Link href={signedIn ? "/dashboard" : "/login"}>{signedIn ? t("nav.dashboard") : t("footer.login")}</Link>
          </nav>
